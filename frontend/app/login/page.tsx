...
export default function Login() {
  ...
  const handleGoogle = () => {
    window.location.href = 'https://resume-builder-79tf.onrender.com/api/auth/google/login'
  }
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0f', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#e8e8f0', marginTop: '16px' }}>Welcome back</h1>
          <p style={{ color: '#888899', marginTop: '8px' }}>Log in to your account</p>
        </div>
        ...
        <div style={{ background: '#111118', border: '1px solid #222230', borderRadius: '16px', padding: '32px' }}>
          ...
          <div style={{ textAlign: 'right', marginBottom: '24px' }}>
            <Link href="/forgot-password" style={{ color: '#6c63ff', fontSize: '13px', textDecoration: 'none' }}>Forgot password?</Link>
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', color: '#888899', fontSize: '14px' }}>
            ...
            <Link href="/signup" style={{ color: '#6c63ff', textDecoration: 'none', fontWeight: 600 }}>Sign up free</Link>
          </p>
        </div>
      </div>
    </main>
